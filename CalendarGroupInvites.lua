...
function GroupCalendar.Invites:ChatMsgSystem(pEventID, pMessage)
...
GroupCalendar_cGroupStatusMessages =
{
	...
	Invited = GroupCalendar_cInvitedGroupStatus,
	Ready = GroupCalendar_cReadyGroupStatus,
...
function GroupCalendar.Invites:AutoSelectPlayers()
	if self.GroupBy == "Role" then
		CalendarRoleLimitsFrame:Open(self.Limits, GroupCalendar_cAutoSelectWindowTitle, true, function (...) GroupCalendar.Invites:AutoSelectFromLimits(...) end)
	else
		CalendarClassLimitsFrame:Open(self.Limits, GroupCalendar_cAutoSelectWindowTitle, true, function (...) GroupCalendar.Invites:AutoSelectFromLimits(...) end)
	end
end
